...
public class ZenScriptConditionalExpressionImpl extends ZenScriptExpressionImpl implements ZenScriptConditionalExpression {

  public ZenScriptConditionalExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
