...
public class ZenScriptInitializerImpl extends ASTWrapperPsiElement implements ZenScriptInitializer {

  public ZenScriptInitializerImpl(@NotNull ASTNode node) {
    super(node);
  }
