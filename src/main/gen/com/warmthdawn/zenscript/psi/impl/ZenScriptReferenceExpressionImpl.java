...
public class ZenScriptReferenceExpressionImpl extends ZenScriptExpressionImpl implements ZenScriptReferenceExpression {

  public ZenScriptReferenceExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
