...
public class ZenScriptDefaultValueImpl extends ASTWrapperPsiElement implements ZenScriptDefaultValue {

  public ZenScriptDefaultValueImpl(@NotNull ASTNode node) {
    super(node);
  }
