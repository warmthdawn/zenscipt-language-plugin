...
public class ZenScriptTypeCastExpressionImpl extends ZenScriptExpressionImpl implements ZenScriptTypeCastExpression {

  public ZenScriptTypeCastExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
