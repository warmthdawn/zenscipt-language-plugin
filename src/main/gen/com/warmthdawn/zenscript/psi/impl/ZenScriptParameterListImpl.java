...
public class ZenScriptParameterListImpl extends ASTWrapperPsiElement implements ZenScriptParameterList {

  public ZenScriptParameterListImpl(@NotNull ASTNode node) {
    super(node);
  }
