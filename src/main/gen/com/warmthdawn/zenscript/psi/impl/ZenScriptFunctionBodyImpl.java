...
public class ZenScriptFunctionBodyImpl extends ASTWrapperPsiElement implements ZenScriptFunctionBody {

  public ZenScriptFunctionBodyImpl(@NotNull ASTNode node) {
    super(node);
  }
